...
BEGIN
  ...
  WHILE v_d <= CURRENT_DATE LOOP
    ...
    FOR v_k IN 1..GREATEST(v_n, 0) LOOP
      ...
      ELSIF v_r < 0.82 THEN
        v_cat := 'shopping'; v_amt := 20 + random() * 160;
